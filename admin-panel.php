...
<html lang="en">
  ...
  <a class="navbar-brand" href="#" style="font-weight: bold;">Health Care Hospital </a>
  ...
  <style >
    .bg-primary {
    background: -webkit-linear-gradient(left, #4FA095, #BAD1C2);
}
...
.btn-primary{
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
     <ul class="navbar-nav mr-auto">
       <li class="nav-item">
        <a class="nav-link" href="index1.php"><i class="fa fa-sign-out" aria-hidden="true"></i>Logout</a>
      </li>
       <li class="nav-item">
  ...
  <div class="col-md-4" style="max-width:25%; margin-top: 3%">
    <div class="list-group" id="list-tab" role="tablist">
      ...
      <a class="list-group-item list-group-item-action" href="#app-hist" id="list-pat-list" role="tab" data-toggle="list" aria-controls="home">Appointments</a>
    ...
    <div class="tab-content" id="nav-tabContent" style="width: 950px;">
      ...
      <div class="tab-pane fade  show active" id="list-dash" role="tabpanel" aria-labelledby="list-dash-list">
        <div class="container-fluid container-fullw bg-white" >
              <div class="row" style="line-height: 1;">
                <p style="width: 100%; color: #4FA095; text-shadow: 7px 2px 10px black; font-weight: 1000; font-size: 80px;">WELCOME</p>
                      <p style="width: 100%; color: #4FA095; text-shadow: 7px 2px 10px black; font-weight: 1000; font-size: 80px;">TO</p>
                      <p style="width: 100%; color: #4FA095; text-shadow: 7px 2px 10px black; font-weight: 1000; font-size: 80px;">HEALTH CARE</p>
                      <p style="width: 100%; color: #4FA095; text-shadow: 7px 2px 10px black; font-weight: 1000; font-size: 80px;">HOSPITAL !!</p>
                </div>
            </div>
          </div>
      ...
      <div class="tab-pane fade" id="list-home" role="tabpanel" aria-labelledby="list-home-list">
        <div class="container-fluid">
          <div class="card">
            <div class="card-body">
              <center><h4>Make an appointment</h4></center><br>
                ...
                document.getElementById('docFees').value = selection;
                  ...
                  <div class="col-md-8">
                    <select name="apptime" class="form-control" id="apptime" required="required">
                      ...
                      <option value="12:00:00">1:00 PM</option>
                      <option value="14:00:00">4:00 PM</option>
                      <option value="16:00:00">8:00 PM</option>
                    </select>

                  </div><br><br>

                  <div class="col-md-4">
                    <input type="submit" name="app-submit" value="Create new entry" class="btn btn-primary" id="inputbtn" style="background-color: #4FA095; border: none; box-shadow: 1px 1px 5px black;">
                  </div>
...
<div class="tab-pane fade" id="app-hist" role="tabpanel" aria-labelledby="list-pat-list">
              ...
              <table class="table table-hover">
                <thead>
                  <tr style="background-color: #4FA095; color: white;">
                      ...
                      echo "Cancelled by Doctor";
                        ...
                        { ?>
	                        ...
	                        <a href="admin-panel.php?ID=<?php echo $row['ID']?>&cancel=update" 
                              ...
                              title="Cancel Appointment" tooltip-placement="top" tooltip="Remove"><button class="btn btn-danger" style="background-color: #4FA095; box-shadow: 1px 1px 5px black; border:none;">Cancel</button></a>
	                        <?php } else {
                      ...
                      <tr>
                        ...
                        <td>
                          <form method="get">
                              ...
                              <input type = "submit" onclick="alert('Bill Paid Successfully');" name ="generate_bill" style="background-color: #4FA095; box-shadow: 1px 1px 5px black; border:none;" class = "btn btn-success" value="Pay Bill"/>
                              </a>
                              </td>
                              </form>
