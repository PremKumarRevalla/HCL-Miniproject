...
(function (e, t, n, r) {
  ...
  var o = {
    init: function (e, t) {
      ...
      if (n.options.singlePageDeeplinking && t === "singlePage") {
        ...
        r = n.cubeportfolio.blocksAvailable
          .find(n.options.singlePageDelegate)
          .filter(function (e) {
            return n.url.split("#cbp=")[1] === this.getAttribute("href");
          })[0];
        if (r) {
          n.url = n.url.replace(/#cbp=(.+)/gi, "");
    ...
    _createMarkup: function () {
      ...
      t.navigation = e("<div/>", { class: "cbp-popup-navigation" }).appendTo(
        t.navigationWrap
      );
    ...
    openSinglePage: function (r, i) {
      ...
      if (
        s.cubeportfolio.browser === "ie8" ||
        s.cubeportfolio.browser === "ie9"
      ) {
        setTimeout(function () {
          s.wrap.addClass("cbp-popup-singlePage-sticky");
        }, 1e3);
    ...
    openSinglePageInline: function (n, r, i) {
      ...
      if (e.isFunction(s.options.singlePageInlineCallback)) {
        s.options.singlePageInlineCallback.call(
          s,
          s.dataArray[s.current].url,
          s.dataArray[s.current].element
        );
    ...
    updateSelfHostedVideo: function (e, t, n) {
      ...
      s +=
        ...
        (r.options.lightboxShowCounter
          ? '<div class="cbp-popup-lightbox-counter">' + n + "</div>"
          : "") +
        "</div>" +
        "</div>";
      r.content.html(s);
    ...
    close: function (n, r) {
      ...
      if (i.type === "singlePageInline") {
        if (n === "open") {
          ...
          e(i.dataArray[i.current].element)
            .parents(".cbp-item")
          ...
          e(i.dataArray[i.current].element)
            ...
            .removeClass("cbp-singlePageInline-active");
          if (
            i.cubeportfolio.browser === "ie8" ||
            i.cubeportfolio.browser === "ie9"
          ) {
            i.content.html("");
            i.wrap.detach();
    ...
    resizeImage: function () {
      ...
      var n = e(t).height(),
        ...
        i =
          ...
          parseInt(r.css("margin-bottom"), 10);
  ...
  var u = {
    ...
    jumpTo: function (t) {
      ...
      r.animate({ opacity: 1 }, function () {
        ...
        r.removeClass("cbp-slider-item-next")
  ...
  var a = {
    _main: function (t, n, r) {
      ...
      if (
        i.options.displayType === "lazyLoading" ||
        i.options.displayType === "fadeIn"
      ) {
        i.$ul.css({ opacity: 0 });
      }
      ...
      if (
        i.options.displayType === "lazyLoading" ||
        i.options.displayType === "sequentially" ||
        i.options.displayType === "bottomToTop" ||
        i.options.displayType === "fadeInToTop"
      ) {
        i._load();
      } else {
        i._beforeDisplay();
    ...
    _fadeInCaption: function () {
      var t = this,
        n;
      if (t.browser === "ie8" || t.browser === "ie9") {
        n = t.browser === "ie9" ? 1 : 0.8;
        e(".cbp-caption")
          .on("mouseenter" + s, function () {
            e(this)
              .find(".cbp-caption-activeWrap")
              .animate({ opacity: n }, "fast");
          })
          .on("mouseleave" + s, function () {
            e(this)
              .find(".cbp-caption-activeWrap")
    ...
    _beforeDisplay: function () {
      ...
      if (e.options.animationType) {
        ...
        e.localColumnWidth =
          e.blocks.eq(0).outerWidth() + e.options.gapVertical;
        if (e.options.defaultFilter === "" || e.options.defaultFilter === "*") {
          e._display();
        } else {
          e.filter(
            e.options.defaultFilter,
            function () {
              e._display();
            },
            e
    ...
    _display: function () {
      ...
      if (
        e.options.displayType === "lazyLoading" ||
        e.options.displayType === "fadeIn"
      ) {
    ...
    _layout: function () {
      ...
      t.blocksAvailable.each(function (n, r) {
        ...
        if (
          t.singlePageInline &&
          n >= t.singlePageInline.matrice[0] &&
          n <= t.singlePageInline.matrice[1]
        ) {
    ...
    _layoutReset: function () {
      ...
      if (t.options.gridAdjustment === "alignCenter") {
        ...
        t.width = t.$obj.width();
        t.cols = Math.max(
          Math.floor((t.width + t.options.gapVertical) / t.localColumnWidth),
          1
        );
    ...
    _responsiveLayout: function () {
      ...
      if (r / t.localColumnWidth > 0.5) {
        t.localColumnWidth =
          t.localColumnWidth - (t.localColumnWidth - r) / (t.cols + 1);
      } else {
    ...
    _quicksandFilter: function (e, t, n) {
      ...
      r.blocksAvailable = r.blocks.filter(n);
      if (e.length) {
        r.styleQueue.push({ $el: e, style: { scale: 0.01, opacity: 0 } });
      }
      if (t.length) {
    ...
    _boxShadowFilter: function (e, t, n) {
      ...
      var s = {};
      if (e.length) {
        e.find(".cbp-animation-boxShadowMask").addClass(
          "cbp-animation-boxShadowActive"
        );
        r.styleQueue.push({ $el: e, style: { opacity: 0 } });
        s = e.last();
      }
      if (t.length) {
        t.find(".cbp-animation-boxShadowMask").addClass(
          "cbp-animation-boxShadowInactive"
        );
        r.styleQueue.push({ $el: t, style: { opacity: 1 } });
        s = t.last();
      }
    ...
    _bounceTopFilter: function (e, t, n) {
      ...
      r.blocksAvailable = s.filter(n);
      r._layout();
      o[r.transition]({ top: "-100%", opacity: 0 })
        .removeClass("cbp-wrapper-front")
        .addClass("cbp-wrapper-back");
      i[r.transition]({ top: 0, opacity: 1 })
        .addClass("cbp-wrapper-front")
        .removeClass("cbp-wrapper-back");
      r._processStyle(r.transitionByFilter);
      r._resizeMainContainer(r.transition);
    ...
    _slideLeftFilter: function (e, t, n) {
      ...
      r.blocks
        ...
        .removeClass("cbp-animation-slideLeft-out cbp-animation-slideLeft-in");
      r.blocksClone
        .find(".cbp-item-wrapper")
        .removeClass("cbp-animation-slideLeft-out cbp-animation-slideLeft-in");
      r.$ul.css({ opacity: 1 });
    ...
    _wrapperFilter: function (t, n, r, i, s) {
      ...
      if (o.transition === "css") {
        ...
        c.each(function (t, n) {
          e(n)
            .find(".cbp-item-wrapper")
            .addClass("cbp-animation-" + i + "-in")
            .css("animation-delay", d / 20 + "s");
          d++;
        });
        l.each(function (t, n) {
          if (d <= p && s) {
            e(n)
              .find(".cbp-item-wrapper")
              .addClass("cbp-animation-" + i + "-fadeOut");
          } else {
            e(n)
              .find(".cbp-item-wrapper")
              .addClass("cbp-animation-" + i + "-out")
              .css("animation-delay", p / 20 + "s");
          }
          p++;
        });
        ...
        if (h.length) {
          h.one(o.animationEnd, function () {
            ...
            if (o.browser === "ie10" || o.browser === "ie11") {
              setTimeout(function () {
                e(".cbp-item-wrapper").removeClass(
                  "cbp-animation-" + i + "-in"
                );
              }, 300);
            }
    ...
    destroy: function (n) {
      ...
      r.$ul
        .removeClass("cbp-wrapper-front cbp-wrapper-back cbp-wrapper no-trans")
        .removeAttr("style");
