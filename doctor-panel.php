  ...
  <div class="col-md-8" style="margin-top: 3%;">
    <div class="tab-content" id="nav-tabContent" style="width: 950px;">
      <div class="tab-pane fade show active" id="list-dash" role="tabpanel" aria-labelledby="list-dash-list">
              ...
              <div class="container-fluid container-fullw bg-white" style="line-height: 1.1;" >
              ...
              <p style="width: 100%; color: #4FA095; text-shadow: 7px 2px 10px black; font-weight: 1000; font-size: 80px;">Doctor &nbsp; <?php echo $_SESSION['dname'] ?>
</p><p style="width: 100%; color: #4FA095; text-shadow: 7px 2px 10px black; font-weight: 1000; font-size: 80px;"> HAVE A GREAT DAY !!</p>
             </div>
           </div>
         </div>
                     ...
                     <td>
                        ...
                        { ?>
	                        ...
	                        <a href="doctor-panel.php?ID=<?php echo $row['ID']?>&cancel=update" 
                              ...
                              title="Cancel Appointment" tooltip-placement="top" tooltip="Remove"><button class="btn btn-danger" style="background-color: #4FA095; box-shadow: 1px 1px 5px black; border:none;">Cancel Appointment</button></a>
	                        <?php } else {
                        ...
                        <button class="btn btn-success" style="background-color: #4FA095; box-shadow: 1px 1px 5px black; border:none;">Prescibe</button></a>
                        <?php } else {
